...
export default function Tools() {
    return <div className='tools'>
      ...
      <h1>How to play DND<br /></h1>
        ...
        <p><strong>Strength</strong> is the ability to crush a tomato or lift a box of tomatoes. We use the strength ability for things like melee weapon attacks, determining our carry weight, and when we perform athletic tasks.</p>
